...
export const useSyncKibanaTimeFilterTime = (
  ...
  const timeUpdate$ = services.data.query.timefilter.timefilter.getTimeUpdate$();
  ...
  useEffect(() => {
    const sub = timeUpdate$.subscribe(() => {
      console.log('time uodate has changed');
      console.log('change');
      if (setTimeRange) {
