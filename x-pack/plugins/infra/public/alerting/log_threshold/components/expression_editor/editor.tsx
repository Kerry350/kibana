...
export const SourceStatusWrapper: React.FC = ({ children }) => {
  ...
  return (
    <>
      {isLoadingSourceConfiguration || isResolvingSourceConfiguration || isUninitialized ? (
        <div>
          <EuiSpacer size="m" />
          <EuiLoadingSpinner size="l" />
          <EuiSpacer size="m" />
        </div>
      ) : hasFailedLoadingSource || hasFailedResolvingSourceConfiguration ? (
        <EuiCallOut
        ...
        >
          <EuiButton
            onClick={hasFailedLoadingSource ? loadSource : loadResolveLogSourceConfiguration}
            iconType="refresh"
          >
