...
export const LogsPageContent: React.FunctionComponent = ({ routingService, routingState }) => {
  ...
  return (
    <>
      ...
      {routingState.matches('stream') ? (
        <StreamPage routingService={routingService} />
      ) : routingState.matches('anomalies') ? (
        <LogEntryRatePage />
      ) : (
        <NotFoundPage />
      )}
